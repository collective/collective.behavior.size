...
project = u'collective.behavior.size'
...
htmlhelp_basename = 'collective.behavior.sizedoc'
...
latex_documents = [
  ('index', 'collective.behavior.size.tex', u'collective.behavior.size Documentation',
...
man_pages = [
    (
        'index',
        'todo',
        u'collective.behavior.size Documentation',
        [u'Taito Horiuchi'],
        1)]
